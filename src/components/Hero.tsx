  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full px-6 relative z-10 mb-20">
        ...
        >
          <motion.div 
            className="inline-block px-4 py-2 bg-[var(--color-terracotta)] text-[var(--color-cream)] font-[family-name:var(--font-data)] text-xs uppercase border-2 border-[var(--color-ink)] cursor-pointer"
          ...
          <motion.div 
            className="inline-block px-4 py-2 bg-[var(--color-gold)] text-[var(--color-ink)] font-[family-name:var(--font-data)] text-xs uppercase border-2 border-[var(--color-ink)] cursor-pointer"
            style={{ boxShadow: "3px 3px 0 var(--color-ink)" }}
            whileHover={{ scale: 1.1, rotate: -5, y: -5 }}
            whileTap={{ scale: 0.95 }}
            animate={{ rotate: [2, 0, 2] }}
          ...
          <motion.div 
            className="inline-block px-4 py-2 bg-[var(--color-paper)] text-[var(--color-ink)] font-[family-name:var(--font-data)] text-xs uppercase border-2 border-[var(--color-ink)] cursor-pointer"
            style={{ boxShadow: "3px 3px 0 var(--color-ink)" }}
        ...
        <div className="overflow-hidden">
          <h1 className="font-[family-name:var(--font-ancient)] text-[15vw] md:text-[12vw] leading-[0.9] text-[var(--color-ink)] uppercase tracking-tighter font-black flex flex-wrap">
            ...
            <motion.span
              className="inline-block text-[var(--color-terracotta)] mx-2 md:mx-4"
        ...
        <div className="overflow-hidden relative">
          <h1 className="font-[family-name:var(--font-ancient)] text-[15vw] md:text-[12vw] leading-[0.9] text-[var(--color-ink)] uppercase tracking-tighter font-black relative">
        ...
        <motion.p
          ...
          className="font-[family-name:var(--font-grotesk)] text-lg md:text-2xl text-[var(--color-stone)] mt-8 max-w-xl"
        >
          The largest{" "}
          <motion.span 
        ...
        <motion.div
          ...
          className="mt-10 md:mt-12 flex flex-col md:flex-row items-start md:items-end gap-6 md:gap-8"
        >
          {/* Prize Pool Sticker */}
          <motion.div
            className="relative bg-[var(--color-paper)] border-4 border-[var(--color-ink)] p-5 md:p-6 cursor-pointer"
          ...
          >
            ...
            >
              <Zap className="w-4 h-4 text-[var(--color-cream)]" />
            </motion.div>
            <motion.div 
              className="font-[family-name:var(--font-ancient)] text-4xl md:text-6xl font-black text-[var(--color-ink)]"
              animate={{ scale: [1, 1.02, 1] }}
              transition={{ duration: 2, repeat: Infinity }}
            >
              25,000+
            </motion.div>
            <div className="font-[family-name:var(--font-data)] text-xs md:text-sm text-[var(--color-stone)] uppercase mt-1">
              Prize Pool (INR)
            </div>
          </motion.div>
          ...
          <motion.button
            ...
            className="relative bg-[var(--color-terracotta)] text-[var(--color-cream)] font-[family-name:var(--font-ancient)] font-black text-lg md:text-2xl px-8 md:px-10 py-4 md:py-5 border-4 border-[var(--color-ink)] uppercase tracking-wide flex items-center gap-3 md:gap-4 group overflow-hidden"
            style={{ boxShadow: "6px 6px 0 var(--color-ink)" }}
          >
            {/* Button shine effect */}
            <motion.div
            ...
            <motion.span
              className="absolute -top-2 -right-2 px-2 py-1 bg-[var(--color-gold)] text-[var(--color-ink)] font-[family-name:var(--font-data)] text-xs border-2 border-[var(--color-ink)] z-20"
              animate={{ 
                rotate: [5, -5, 5],
                scale: [1, 1.1, 1],
              }}
        ...
        <motion.p
          ...
          className="font-[family-name:var(--font-data)] text-xs text-[var(--color-stone)] mt-8 flex items-center gap-2"
        >
          <motion.span
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 3 }}
        className="absolute bottom-0 left-0 right-0 w-full border-y-4 border-[var(--color-ink)] bg-[var(--color-gold)] py-3 overflow-hidden z-20"
      >
        <div className="marquee-track font-[family-name:var(--font-ancient)] font-bold text-base md:text-lg text-[var(--color-ink)] uppercase tracking-wider">
