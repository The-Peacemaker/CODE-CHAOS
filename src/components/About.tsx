...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-8 right-8 w-24 h-24 bg-[var(--color-cream)] border-3 border-[var(--color-ink)] flex items-center justify-center"
        style={{ boxShadow: "4px 4px 0 var(--color-ink)", rotate: "12deg" }}
        animate={{ rotate: [12, 15, 12] }}
        transition={{ duration: 4, repeat: Infinity }}
      >
        <div className="text-center font-[family-name:var(--font-data)] text-xs text-[var(--color-ink)]">
          <div className="text-[var(--color-terracotta)] font-bold">SEC</div>
          <div className="text-3xl font-black text-[var(--color-ink)]">01</div>
        </div>
      </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-[family-name:var(--font-ancient)] text-6xl md:text-8xl font-black text-[var(--color-ink)] leading-none">
            What is
            <br />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div
            ...
            className="bg-[var(--color-cream)] border-4 border-[var(--color-ink)] p-8 md:p-10 relative"
          ...
          >
            ...
            <p className="font-[family-name:var(--font-grotesk)] text-xl md:text-2xl text-[var(--color-ink)] leading-relaxed mb-6">
            ...
            <p className="font-[family-name:var(--font-grotesk)] text-lg text-[var(--color-stone)] leading-relaxed">
            ...
            {/* Corner fold effect */}
            <div className="absolute bottom-0 right-0 w-12 h-12 bg-[var(--color-paper)] border-l-4 border-t-4 border-[var(--color-ink)]" 
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                <div 
                  className="w-10 h-10 border-2 border-[var(--color-ink)] rounded-full flex items-center justify-center mb-3"
                  style={{ backgroundColor: stat.color }}
                >
                  <stat.icon className="w-5 h-5 text-[var(--color-cream)]" />
                </div>
                <div className="font-[family-name:var(--font-data)] text-xs text-[var(--color-stone)] uppercase tracking-wider mb-1">
                  {stat.label}
                </div>
                <div className="font-[family-name:var(--font-ancient)] text-2xl font-black text-[var(--color-ink)]">
                  {stat.value}
                </div>
              </motion.div>
            ))}
        ...
        >
          <motion.div
            className="bg-[var(--color-terracotta)] text-[var(--color-cream)] border-4 border-[var(--color-ink)] p-6"
            style={{ boxShadow: "6px 6px 0 var(--color-ink)", rotate: "1deg" }}
            whileHover={{ rotate: 0, scale: 1.02 }}
          >
            <div className="font-[family-name:var(--font-ancient)] text-xl font-bold mb-3">
              Venue
            </div>
            <div className="font-[family-name:var(--font-grotesk)] text-lg">
              Programming Lab, Multimedia Lab & Room D401
            </div>
            <div className="font-[family-name:var(--font-data)] text-sm opacity-80 mt-2">
              VJCET Campus, Vazhakulam
            </div>
          </motion.div>

          <motion.div
            className="bg-[var(--color-gold)] text-[var(--color-ink)] border-4 border-[var(--color-ink)] p-6"
            style={{ boxShadow: "6px 6px 0 var(--color-ink)", rotate: "-1deg" }}
            whileHover={{ rotate: 0, scale: 1.02 }}
          >
            <div className="font-[family-name:var(--font-ancient)] text-xl font-bold mb-3">
